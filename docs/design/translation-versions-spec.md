...
```text
GET /documents/{documantions_id}/preview?translation_version_id={translation_version_id}
```
...
| POST | `/documents/{documantions_id}/translation-versions/{version_id}/retry` | Admin or requester when allowed | Retry failed version |
| GET | `/documents/{documantions_id}/preview?translation_version_id=...` | Document access | Render selected version |
