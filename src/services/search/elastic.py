...
class ElasticsearchSearchClient:
    ...
    def index_document(self, document_id: str, document: dict[str, Any]) -> None:
        """Index or update a document by *document_id*."""
        self._client.index(index=INDEX_NAME, id=document_id, document=document)

    def delete_document(self, document_id: str) -> None:
        """Remove a document from the index."""
        self._client.delete(index=INDEX_NAME, id=document_id)
