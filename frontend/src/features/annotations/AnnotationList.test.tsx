...
vi.mock("@/api/annotations", () => ({ listAnnotations: mocks.listAnnotations, createAnnotation: vi.fn() }));
...
test("renders annotations mapped from the backend envelope", async () => {
  mocks.listAnnotations.mockResolvedValueOnce([
    { id: "a1", doc_id: "d1", author_id: "u1", author_name: "Ari", body: "Shared backend note", position: { page: 2 }, shared: true, created_at: "2026-05-01T10:00:00Z", updated_at: "2026-05-01T11:00:00Z" },
    { id: "a2", doc_id: "d1", author_id: "u2", author_name: "Bo", body: "Private backend note", position: null, shared: false, created_at: "2026-05-01T10:00:00Z", updated_at: "2026-05-01T11:00:00Z" },
  ]);
