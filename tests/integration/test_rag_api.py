...
def test_qa_returns_answer_and_citations(migrated_engine: Engine) -> None:
    ...
    documantions_id = _create_doc(migrated_engine, "admins", "Procurement Policy")
    ...
    assert data["citations"][0]["documantions_id"] == str(documantions_id)
...
def test_qa_ollama_failure_returns_fallback(migrated_engine: Engine) -> None:
    ...
    documantions_id = _create_doc(migrated_engine, "admins", "Fallback Doc")
...
def test_qa_top_k_limits_chunks(migrated_engine: Engine) -> None:
    ...
    documantions_id = _create_doc(migrated_engine, "admins", "Multi Chunk Doc")
