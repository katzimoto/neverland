...
def test_upsert_chunks_success() -> None:
    ...
    assert points[0].payload["documantions_id"] == "doc-1"
...
def test_search_vector() -> None:
    ...
    mock_qdrant.query_points.return_value.points = [
        MagicMock(score=0.95, payload={"documantions_id": "doc-1", "text": "hello"}),
        MagicMock(score=0.85, payload={"documantions_id": "doc-1", "text": "world"}),
    ]
    client._client = mock_qdrant
    ...
    assert results[0].documantions_id == "doc-1"
